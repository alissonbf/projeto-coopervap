...
class Ui_tecnico(object):
    def setupUi(self, tecnico):
        ...
        self.formLayout_2.setWidget(2, QtGui.QFormLayout.FieldRole, self.EditFuncao)
        ...
        self.comboDepto = QtGui.QComboBox(self.frame)
        self.comboDepto.setEnabled(True)
        self.comboDepto.setObjectName("comboDepto")
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.FieldRole, self.comboDepto)
        self.EditUsuario = QtGui.QLineEdit(self.frame)
        self.EditUsuario.setEnabled(False)
        self.EditUsuario.setAutoFillBackground(True)
        self.EditUsuario.setObjectName("EditUsuario")
        self.formLayout_3.setWidget(0, QtGui.QFormLayout.FieldRole, self.EditUsuario)
    ...
    def retranslateUi(self, tecnico):
        ...
        self.label_3.setText(QtGui.QApplication.translate("tecnico", "Departamento", None, QtGui.QApplication.UnicodeUTF8))
